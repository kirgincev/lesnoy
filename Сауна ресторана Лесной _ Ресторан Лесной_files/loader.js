...
(function (window, undefined) {
    var loader,
        ...
        readyModules = [],
        onReadyCallbacks = [],
        branch = window.location.href.match(/__branch=([a-z0-9\-]+)/i),
        protocol,
        statBrowserName,
        hosts = {};
    ...
    if (!!window.location.href.match(/__prerelease/i)) {
        hosts.connect = protocol + "connect.myalpha6.i.mail.ru/";
        hosts.imgsmail = protocol + "psi.imgsmail.ru/";
        hosts.appsmail = protocol + "myalpha6.appsmail.ru/";
        hosts.mymail = protocol + "my.myalpha6.i.mail.ru/";
    } else if (branch) {
        hosts.connect = protocol + branch + ".connect.myalpha15.i.mail.ru/";
        hosts.imgsmail = protocol + branch + ".myalpha.imgsmail.ru/";
        hosts.appsmail = protocol + branch + ".myalpha15.appsmail.ru/";
        hosts.mymail = protocol + branch + ".my.myalpha15.i.mail.ru/";
    } else {
        hosts.connect = protocol + "connect.mail.ru/";
        hosts.imgsmail = protocol + "my2.imgsmail.ru/";
        hosts.appsmail = protocol + "www.appsmail.ru/";
        hosts.mymail = protocol + "my.mail.ru/";
    }
    ...
    if (mailru.browser.name === 'Opera' && mailru.browser.version < 15) {
        mailru.isOpera = true;
        statBrowserName = 'OperaPresto';
    } else if (mailru.browser.name === 'MSIE') {
        mailru.isIE = true;
        statBrowserName = mailru.browser.name + mailru.browser.version;
    } else {
        statBrowserName = mailru.browser.name;
    }

    (new Image()).src = protocol + 'my.mail.ru/grstat?value=1&name=my.api.browsers.' + statBrowserName + '&r=' + Math.random();
